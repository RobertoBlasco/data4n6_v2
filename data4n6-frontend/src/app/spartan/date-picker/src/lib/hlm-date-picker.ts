...
export class HlmDatePicker<T> implements ControlValueAccessor {
  ...
  protected readonly _computedClass = computed(() =>
    hlm(
      'ring-offset-background border-primary bg-action/5 hover:bg-accent dark:bg-input/30 dark:hover:bg-input/50 inline-flex h-9 w-[280px] cursor-default items-center justify-between gap-2 rounded-md border px-3 py-2 text-left text-sm font-normal whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50',
