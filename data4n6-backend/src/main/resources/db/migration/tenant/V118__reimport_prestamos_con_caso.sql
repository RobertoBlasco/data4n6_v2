-- Redo the loan/return import (originally V107) to populate t100_casos_id.
-- V112 added the column; V117 created the stub cases.
-- Steps: delete existing import data → re-insert with caso FK → recalculate
--        estado_resultante and descripcion_estado for affected articles.

-- ── 1. Delete existing import (reverse dependency order) ─────────────────────
...
-- ── 3. Re-insert PRS header subtable — now includes t100_casos_id ────────────
