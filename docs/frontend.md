...
Usar **Angular Material** (`@angular/material`) y **PrimeNG** (`primeng`) indistintamente según las necesidades de cada componente. Ambas están instaladas y son válidas. No hay preferencia fija — elegir la que mejor se adapte al caso concreto.
